...
`MeetingType`='$MeetingType',`CourseFees`='$CourseFees',`TotalCapacity` ='$TotalCapacity',`Instigator`='$Instigator',`InsId`='$InsName' where `CourseID`='$demo'";
                        ...
                        <table class="table">
                            ...
                            <tr>
							 ...
							 <tr>
								...
								<td>
									Current Image:<br><img src="upload/<?php echo $row['Image'];?>" height="80px" 
									width="120px"><br>
									...
									<span style="padding:0px 15px 0px 15px; margin-top:20px; position:relative; top:10px;">or</span>
										...
										<label type="button" id="upload_btn_img" for="Image" style=" margin-top:20px;" class="btn btn-info btn-lg">Upload image <input type="file"  name="Image" value="<?php echo $row['Image']; ?>" style="display:none;" id="Image" class="img"/></label>
										<br><br>
