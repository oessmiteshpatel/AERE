...
if(isset($_POST['save'])) 
{
	...
	if($Image!='')
	{
		...
		`CreatedOn`,`ModifiedBy`,`ModifiedOn`)
				...
				'$MeetingType','$CourseFees','$TotalCapacity','0','$Instigator','$InsName','0',now(),'0',now())"; 
	...
	else 
	{
		...
		`CreatedBy`,
		`CreatedOn`,`ModifiedBy`,`ModifiedOn`)
                VALUES('$Title','$OfferedBy','$Summary','4.jpg','$Video','$StartDate','$EndDate','$Location','$SSTime','$EETime','$IntendedAudience',
				'$MeetingType','$CourseFees','$TotalCapacity','0','$Instigator','$InsName','0',now(),'0',now())"; 
	...
	$res = mysql_query($query);
	  ...
	  {
		 ?>
						<center><div class="alert alert-success" id="insert_rec" style="width:1200px; margin:0px 0px 10px 0px">
	...
	<?php
	  ...
	  {
		   ?>
						<center><div class="alert alert-danger" id="rec_not_insert" style="width:1200px; display:inline-block; margin:0px 0px 10px 0px; fonnt-size:20px"><strong>Your record was not inserted...!</strong> 
             </div>  
						</center>
	<script>
		setTimeout(function() {
    ...
    <div class="row">
        <div class="col-md-12">
         ...
         <div class="panel-heading">      
                     <h3 class="panel-title"><b>Add A Course</b> </h3>  
                        ...
                        <tr>
						 ...
						 <tr>
								...
								<td>
									...
									<button type="button" id="select_btn_img" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal" style="margin-top:20px;">Select new image</button>
									<span style="padding:0px 15px 0px 15px; margin-top:20px; position:relative; top:10px;">or</span>

										<label type="button" id="upload_btn_img" for="Image" style=" margin-top:20px;" class="btn btn-info btn-lg">Upload image <input type="file"  name="Image" style="display:none;" id="Image" class="img"
										reuired/></label>
										<br><br>
