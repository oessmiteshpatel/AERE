...
<div class="panel panel-default">
    <div class="panel-heading">                                
        <h3 class="panel-title"><b>List of Instructor</b> </h3>   
    ...
    <div class="panel-body">
        <table id="customers2" class="table datatable">
            <thead>
                <tr>
                    <th class="text-center" width="10">InsId</th>
                    <th class="text-center" width="5">Instructor Name </th>

                    <th class="text-center"  width="330">About</th>
            ...
            <tbody>
                ...
                while ($row = mysql_fetch_array($result)) 
				{
                    ...
                    <tr>
                       <?php //echo $i; ?>
						<td class="text-center"><?php echo $row['InsId']; ?></td>
                        <td class="text-center" width="280"><?php echo $row['InsName']; ?></td>
                       ...
                       <!-- <td class="text-center"><?php //echo date_format($sdate, 'm/d/Y') ?></td>
						...
						<td class="text-center">  
                            ...
                            if (($IsActive) == '0') {
                                ?>
                                <a href="action_Ins.php?IsActive=<?php echo $row['InsId']; ?>" 
