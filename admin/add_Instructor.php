...
if(isset($_POST['save'])) 
{
 ...
 if($InsImg!="")
	...
	else 
	{
		 ...
		 $query = "INSERT INTO tblmstinstructor(
		`InsName`,`InsImg`,`About`,`IsActive`,`CreatedBy`,`CreatedOn`,`UpdatedBy`,`UpdatedOn`)
                VALUES('$InsName','13.jpg','$About','$IsActive','0',now(),'0',now())"; 
			//var_dump($query);exit;
}
	//exit;
    ...
    <div class="row">
        <div class="col-md-12">
         ...
         <div class="panel-heading">      
                     <h3 class="panel-title"><b>Add A Instructor</b> </h3>  
                ...
                <form name="form_instructor" id='form_instructor' method="post" class="my_frm"  enctype="multipart/form-data" >
                    ...
                    <table class="table">
                      ...
                      <tr>
                            ...
                            <td><input type="text" name="InsName" id="InsName" class="form-control" placeholder="Type type Instructor Name" maxlength="150"/></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <textarea  name="About" id="About" style="width:90%;height:200px;"  class="form-control" placeholder="Description" /></textarea>
                            </td>
                        </tr>
						 ...
						 <tr>
								...
								<td>
									...
									<span style="padding:0px 15px 0px 15px; margin-top:20px; position:relative; top:10px;">or</span>
										...
										<label type="button" id="upload_btn_img2" for="InsImg" style=" margin-top:20px;" class="btn btn-info btn-lg">Upload image <input type="file"  name="InsImg" style="display:none;" id="InsImg" class="img"
										required/></label>
										<br><br>
