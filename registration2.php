  ...
  $('#already_exist').fadeOut('hide');
		...
		else
		{
			...
			echo"<script>window.location='conf_otp.php?cid=$cid';</script>";
											...
											if($ins)
											{	?>
          <div class="alert alert-success" id="register_success" style="width:262px; display:inline-block; margin:0px 0px 10px 0px"> <strong>You are register successfully.</strong> <br>
...
?>
            <div class="sidebar-box">
              <div class="sidebar-box-inner">
                ...
                <div class="sidebar-course-price">
                  <p><?php echo $data['StartDate']; ?>&nbsp;/&nbsp;<?php echo $data['StartTime'];?></p>
                </div>
								   ...
								   if($data3['Video']!='')
								   {
									 ?>
									  <div class="youtube-popup">
                                       <iframe width="210px" height="150" src="<?php echo 'http://www.youtube.com/embed/'.$data3['Video'];?>" frameborder="0" allowfullscreen></iframe>
