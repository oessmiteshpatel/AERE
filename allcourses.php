...
<div id="container">
	...
	<!-- NEW CODE HERE  -->								
        ...
        <div class="inner-page-banner-area" style="background-image: url('image/title8.jpg');">
            <div class="container">
                        ...
                        <div class="courses-box1">
                            <div class="single-item-wrapper" style="float:left">
                            	<div style="height:180px;width:1100px; background-color:lightgrey;padding:25px" >
                                    <center style="font-size:24px;margin-top:40px;">   No Courses are available.</center>
									</div>
                                ...
                                <div class="courses-content-wrapper">
								   ...
								   <ul class="courses-info" style="height:50px;">
                                    ...
                                    <ul class="courses-info smallfonts">
                                       ...
                                       <li style="font-size:12px;"><?php echo $data['StartDate'];?>
                                            <br><span> <b> Start Date </b></span></li>
                                        <li style="font-size:12px;"><?php  $noofuserreg=$data['NoofUserRegistered'];	
															$totcap=$data['TotalCapacity'];
															$setave=$totcap-$noofuserreg; 
															if($setave!=''){ echo $setave;}else{echo  "Close";}?>
                                            <br><span>  <b> Seats </b></span></li>
									<li style="font-size:12px;"><?php $D=date("g:i a", strtotime($data['StartTime']));echo $D; ?> to <?php $D=date("g:i a", strtotime($data['EndTime']));echo $D; ?>
                                            <br><span> <b>Time</b></span></li>
										</ul>
                                </div>
