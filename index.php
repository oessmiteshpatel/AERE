              ...
              <div class="panel-group wow fadeInUp" id="accordion" role="tablist" aria-multiselectable="true">
                ...
                <div class="panel panel-default">
                  <div class="panel-heading" role="tab" id="headingOne1">                   
                          ...
                          <a style="padding:20px !important;" class="color" data-toggle="collapse" data-parent="#accordion" aria-expanded="false" aria-controls="collapseOne1" href="OnePager\No  1 - 21 Question to Consider When Developing a New Credential (final, Aug-24-2016).pdf" target="_blank">#1 Oct 2015 – 21 Questions to Consider When Developing a New Credential</a>
                                        <a class="color" style="padding:20px !important;" data-toggle="collapse" data-parent="#accordion" aria-expanded="false" aria-controls="collapseOne1" href="OnePager\No 2 - How to Write Evidence-Based Instructional Objectives Effectivelys.pdf" target="_blank">#2 Nov 2015 – How to Write Evidence-Based Instructional Objectives Effectively</a>
                                        <a class="color" style="padding:20px !important;" data-toggle="collapse" data-parent="#accordion" aria-expanded="false" aria-controls="collapseOne1" href="OnePager\No 3 - What should your organization consider when evaluating pass rates (fina_, Dec 12 2015).pdf" target="_blank">#3 Dec 2015 – What Should Your Organization Consider When Evaluating Pass Rates?</a>
                                        <a class="color" style="padding:20px !important;" data-toggle="collapse" data-parent="#accordion" aria-expanded="false" aria-controls="collapseOne1" href="OnePager\No 4 - What You Need to Know About Cognitive Levels and Bloom's Taxonomy.pdf" target="_blank">#4 Jan 2016 – What You Need to Know About Cognitive Levels and Bloom's Taxonomy</a>
                                        <a class="color" style="padding:20px !important;" data-toggle="collapse" data-parent="#accordion" aria-expanded="false" aria-controls="collapseOne1" href="OnePager\No 5 - What Are Neuroassessments.pdf" target="_blank">#5 Spring 2016 – What Are Neuroassessments?</a>
                                        <a class="color" style="padding:20px !important;" data-toggle="collapse" data-parent="#accordion" aria-expanded="false" aria-controls="collapseOne1" href="OnePager\No 6 - Certificate vs Certification.pdf" target="_blank">#6 Summer 2016 – Certificate vs Certification</a>
                                        <a class="color" style="padding:20px !important;" data-toggle="collapse" data-parent="#accordion" aria-expanded="false" aria-controls="collapseOne1" href="OnePager\No 7 - KSAOs (feb 6 2017).pdf" target="_blank">#7 Winter 2017 - Understanding KSAOs</a>
                                        <a class="color" style="padding:20px !important;" data-toggle="collapse" data-parent="#accordion" aria-expanded="false" aria-controls="collapseOne1" href="OnePager\No8_Stackable_Credentials.pdf" target="_blank">#8 Stackable Credentials</a>
                      </h4>
                  </div>
                                    ...
                                    <div class="panel-group wow fadeInUp" id="accordion" role="tablist" aria-multiselectable="true">
                                        ...
                                        <div class="panel panel-default">
                                            <div class="panel-heading" role="tab" id="headingOne1">
                                                <h4 class="panel-title">
                                                    <a class="color" style="padding:20px !important;" data-toggle="collapse" data-parent="#accordion" aria-expanded="false" aria-controls="collapseOne1" href="MultiPager\2016 ATP Four Innovative Ways to Lead and Facilitate Groups in the Testing Industry White Paper.pdf" target="_blank">#1 Four Innovative Ways to Lead and Facilitate Groups in the Testing Industry White Paper</a>
                                                    <a class="color" style="padding:20px !important;" data-toggle="collapse" data-parent="#accordion" aria-expanded="false" aria-controls="collapseOne1" href="MultiPager\Primer on Neuroassessments.pdf" target="_blank">#2 Primer on Neuroassessments</a>
                                                    <a class="color" style="padding:20px !important;" data-toggle="collapse" data-parent="#accordion" aria-expanded="false" aria-controls="collapseOne1" href="MultiPager\Five Innovative Practices to Manage and Work wit Big Data Presented at E-ATP 2015.pdf" target="_blank">#3 Five Innovative Practices to Manage and Work with Big Data Presented at E-ATP 2015</a>
                                                    <a class="color" style="padding:20px !important;" data-toggle="collapse" data-parent="#accordion" aria-expanded="false" aria-controls="collapseOne1" href="MultiPager\2017 Stackable Credentials - Executive Bulleted Research Brief final 28_Feb_2017.pdf" target="_blank">#4 Stackable Credentials – Executive Bulleted Research Brief</a>
                                                </h4>
                                            </div>
...
?>
        ...
        <div class='gf_browser_unknown gform_wrapper' id='gform_wrapper_6' >
          <form method="post" enctype="multipart/form-data" >
                  ...
                  <ul id="gform_fields_6" class="gform_fields top_label form_sublabel_below description_below">
                       <li id="field_6_1" class="gfield gfield_contains_required field_sublabel_below field_description_below">
                          ...
                          <div class="ginput_container">
                            <input name="fname"  class="large" placeholder="* First Name" type="text" required oninvalid="this.setCustomValidity('Please enter your First Name')" oninput="setCustomValidity('')">
                          </div>
                      </li>
                    <li id="field_6_4" class="gfield field_sublabel_below field_description_below">
                        ...
                        <div class="ginput_container">
                            <input name="contact"  class="large"  placeholder="* Phone Number" type="text" pattern="[0-9\-.\s]+" required oninvalid="this.setCustomValidity('Please enter your Phone Number in xxx.xxx.xxxx format')" oninput="setCustomValidity('')">
                        </div>
                    </li>
                    <li id="field_6_3" class="gfield gfield_contains_required field_sublabel_below field_description_below">
                        ...
                        <div class="ginput_container">
                          <input name="email"   class="large" placeholder="* Email" type="email" required oninvalid="this.setCustomValidity('Please enter your Email')" oninput="setCustomValidity('')">
                        </div>
                    </li>
					<li>
           ...
           <div class="gform_body">
              ...
              <tr>
					    <div class="ginput_container">
                          <input name="code" id="code" class="large" required placeholder="* Enter captcha code" type="text"  required oninvalid="this.setCustomValidity('Please enter the valid Code')" oninput="setCustomValidity('')">
						   <?php
   ...
   <div class="copyright">
    <div class="container">
      <div class="row">
        <div class="col-md-12 col-sm-12 design">Powered by <a style="color:white"; href="http://www.theopeneyes.com/" target="_blank">OpenEyes Technologies, Inc.</a></div>
      </div>
    </div>
  </div>
