...
$instructordata=mysql_query("SELECT tblcourse.CourseID,tblcourse.InsId, tblmstinstructor.InsName, tblmstinstructor.InsImg,tblmstinstructor.About
FROM tblcourse
INNER JOIN tblmstinstructor ON tblcourse.InsId=tblmstinstructor.InsId where tblcourse.CourseID='".$_REQUEST['cid']."'");
...
<div id="container">
            ...
            <div class="container">
                <div class="row">
					...
					<?php
						...
						{
							?>
							<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 all" style="padding:0px;">
                        
                            <div class="single-item-wrapper" style="float:left; ">
                            	<div style="height:180px;width:850px; background-color:lightgrey;padding:25px" >
                                    <center style="font-size:24px;margin-top:40px;">   No Course are available.</center>
									</div>
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                        ...
                                        <div class="tab-content">
                                             <div class="tab-pane fade active in" id="description">
												...
												<div class="col-lg-6">
													<h3 class="sidebar-title"  style="font-size:16px; text-transform:none;">Instructor(s)</h3>
													...
													<h3 class="sidebar-title" style="font-size:16px;">Total Available Seats</h3>
													<p>
													<div id="num"></div>
													<script>
													...
													// $noofuserreg=$data['NoofUserRegistered'];	
															...
															// if($setave!=''){ echo $setave;}else{echo  "Not Avilable";}
															?>
   ...
   if($selectId>0)
   {
	...
	?>									<br>
                                                    <ul style="margin: 0 !important;">
                                                        <li>
                                                            <div class="skilled-lecturers-img">
                                                                <a href="#"><img src="admin/instructor/<?php  echo $datainstructor1['InsImg'];?>" class="img-responsive" alt="skilled" style="    width: 100px; text-align: center; position: relative; margin: auto;"></a>
                                                            </div>
                                                            <div class="skilled-lecturers-content">
                                                                <h4 style="margin-top: 40px;"><a href="#"><?php  echo $datainstructor1['InsName'];?></a></h4>
                                                               
                                                            </div>
                                                            
                                                            <div class="skilled-lecturers-details">
                                                                <a style="margin-top: 30px;" 
																href="instructor.php?InsId=<?php echo $datainstructor1['InsId']; ?>" target="_blank" class="details-accent-btn btn-t">Details</a>
                                                            </div>
                                                        </li>
		...
		{
			?>
			<div style="background: #ccc;color: #000;font-size: 20px;text-align: center;padding: 50px 20px;">
...
?>
                                <div class="courses-box1">
                                    <div class="single-item-wrapper" style="300px">
                                       	<div class="courses-img-wrapper hvr-bounce-to-bottom" style="position:relative;">
								  
                                    <img src="admin/upload/<?php echo $data1['Image'];?>" style="height:190px; width:auto;" 
									alt="">
								   ...
								   if($data2['Video']!='')
								   {
									 ...
									 <a href="https://www.youtube.com/watch?v='.'$data2['Video']'">
									  <div class="youtube-popup">
                                       <iframe width="210px" height="150" src="<?php echo 'http://www.youtube.com/embed/'.$data2['Video'];?>" frameborder="0" allowfullscreen></iframe>
									   <div>
									</a>	   
									   </div>
									</div>
 ...
 <?php
	...
	{ 
		...
		?>
				...
				<div class="alert alert-success" id="succes_login_id" style="width:262px; margin:0px 0px 10px 0px">
